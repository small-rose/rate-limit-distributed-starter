...
package cn.xiaocai.limiter.common.utils;

import java.util.Random;
import cn.xiaocai.limiter.common.exception.RateLimitRuntimeException;
...
public final class IdWorkerUtils {
    ...
    private synchronized long nextId() {
        ...
        if (timestamp < lastTimestamp) {
            throw new RateLimitRuntimeException(String.format("Clock moved backwards.  Refusing to generate id for %d milliseconds", lastTimestamp - timestamp));
        }
